...
// Radix doesn't ship a separate alert-dialog primitive in the trimmed
// dependency set here, so this reuses @radix-ui/react-dialog (same
// underlying behavior shadcn's alert-dialog uses, just without the
// non-dismissable-by-overlay-click distinction -- fine for confirm dialogs).
